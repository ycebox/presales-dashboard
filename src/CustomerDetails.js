// CustomerDetails.js - with Status + Account Manager dropdown + full layout
...
import {
  ...
  FaBuilding, FaGlobe, FaCalendarAlt, FaChartLine, FaCheckCircle,
            ...
            <div className="section-card">
              ...
              <div className="section-content">
                <div className="customer-info-grid">
                  ...
                  {/* Account Manager - dropdown from account_managers */}
                  <div className="info-item">
                    <label className="info-label">
                      <FaUsers />
                      Account Manager
              ...
              <div className="section-content">
                <div className="task-analytics-grid">
                  ...
                  <div className="analytics-item">
                    ...
                    <div className="analytics-content">
                      <div className="analytics-value">{getOverdueTasksCount()}</div>
